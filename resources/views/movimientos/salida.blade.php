...
<div class="flex w-full">
    ...
    <main class="flex-1 p-10">
        ...
        <p class="mb-6 text-gray-600">Registrar salida de unidades a tu inventario</p>
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" name="cantidad" value="{{ old('cantidad') }}" min="1"
                               class="w-full px-4 py-2 border rounded-xl focus:ring-2 focus:ring-green-400" placeholder="Ej. 3">
                        @error('cantidad')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
